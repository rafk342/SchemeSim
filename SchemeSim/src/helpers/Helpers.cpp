...
std::vector<std::string> Utils::split_string(const std::string& input, const std::string& delimiters, uint16_t expected_vec_size)
{
...
std::string Utils::strip_string(const std::string& str)
{
    if (str.empty())
        return str;
